...
(function () {
    ...
    ViewFieldView = (function (_super) {
        ...
        ViewFieldView.prototype.render = function () {
            ...
            this.$el.addClass('response-field-' + this.model.get(Formbuilder.options.mappings.FIELD_TYPE)).attr('orderNo', this.model.cid).data('cid', this.model.cid).html(Formbuilder.templates["view/base" + (!this.model.is_input() ? '_non_input' : '')]({
                rf: this.model
            }));
            return this;
        };
    ...
    EditFieldView = (function (_super) {
        ...
        EditFieldView.prototype.events = {            
            ...
            'click .js-add-matrix-header': 'addMatrixHeaderOptions',// matrix header option
            'click .js-remove-matrix-header': 'removeMatrixHeaderOptions',
            'click .js-add-matrix-row': 'addMatrixRowOptions',   // matrix row option 
            'click .js-remove-matrix-row': 'removeMatrixRowOptions',
        };
        ...
        EditFieldView.prototype.addMatrixRowOptions = function (e) {
            var $el, i, newOption, options;
            $el = $(e.currentTarget);
            i = this.$el.find('.option').index($el.closest('.option'));
            options = this.model.get(Formbuilder.options.mappings.MATRIXROWOPTION) || [];
            newOption = {
                label: ""
            };
            if (i > -1) {
            ...
            this.model.set(Formbuilder.options.mappings.MATRIXROWOPTION, options);
            this.model.trigger("change:" + Formbuilder.options.mappings.MATRIXROWOPTION);
            return this.forceRender();
        };

        EditFieldView.prototype.removeMatrixRowOptions = function (e) {
            var $el, index, options;
            $el = $(e.currentTarget);
            index = this.$el.find(".js-remove-matrix-row").index($el);
            options = this.model.get(Formbuilder.options.mappings.MATRIXROWOPTION);
        ...
        EditFieldView.prototype.addMatrixHeaderOptions = function (e) {
           
            var $el, i, newOption, options;
            $el = $(e.currentTarget);
            i = this.$el.find('.option').index($el.closest('.option'));
            options = this.model.get(Formbuilder.options.mappings.MATRIXHEADEROPTION) || [];
            newOption = {
                label: ""                
            };
            if (i > -1) {
            ...
            this.model.set(Formbuilder.options.mappings.MATRIXHEADEROPTION, options);
            this.model.trigger("change:" + Formbuilder.options.mappings.MATRIXHEADEROPTION);
            return this.forceRender();
        };

        EditFieldView.prototype.removeMatrixHeaderOptions = function (e) {
            var $el, index, options;
            $el = $(e.currentTarget);
            index = this.$el.find(".js-remove-matrix-header").index($el);
            options = this.model.get(Formbuilder.options.mappings.MATRIXHEADEROPTION);
            options.splice(index, 1);
            this.model.set(Formbuilder.options.mappings.MATRIXHEADEROPTION, options);
            this.model.trigger("change:" + Formbuilder.options.mappings.MATRIXHEADEROPTION);
    ...
    BuilderView = (function (_super) {
        ...
        BuilderView.prototype.bindSaveEvent = function () {
            ...
            var _this = this;
            this.formSaved = false; // set false since no need to  check saved or not 
            ...
            //-- display the js confirm message when changed and reload 
        ...
        BuilderView.prototype.setSortable = function () {
            ...
            this.$responseFields.sortable({
                ...
                update: function (e, ui) {
                    ...
                    $(".fb-response-fields div.fb-field-wrapper").each(function (i, elm) {

                         
                        $elm = $(elm); // cache the jquery object
                        var newIndex = $elm.index(".fb-response-fields div.fb-field-wrapper");
                        var recentIndext = +$elm.attr("orderNo");

                        var recentQuestionModel = $.grep(_this.collection.models, function (element, index) {
                            return +element.cid === recentIndext;
                        });
                        // set new index value for View HTML code                        
                        recentQuestionModel[0].orderNo = newIndex; // set new index value for model cid for order 
        ...
        BuilderView.prototype.saveForm = function (e) {           
            ...
            //}
            //this.formSaved = true;
            //this.saveFormButton.attr('disabled', false).text(Formbuilder.options.dict.ALL_CHANGES_SAVED);
             
            this.collection.models.sort(function (a, b) {
                return (+a.orderNo > +b.orderNo) ? 1 : ((+b.orderNo > +a.orderNo) ? -1 : 0);
            });
    ...
    Formbuilder = (function () {
        ...
        Formbuilder.options = {
            ...
            mappings: {
                ...
                FIELDID: 'field_options.fieldId',
                UNITS: 'field_options.units',
                LABEL: 'label',
                VIDEOURL: 'videoUrl',
                ISIMAGEUPLOAD: 'isImageUpload',
                ISVOICEUPLOAD: 'isVoiceUpload',
                FIELD_TYPE: 'field_type',
                REQUIRED: 'required',
                ADMIN_ONLY: 'admin_only',
                OPTIONS: 'field_options.options',
                MATRIXHEADEROPTION: 'field_options.matrixHeaderOptions',
                MATRIXROWOPTION: 'field_options.matrixRowOptions',
...
(function () {
    Formbuilder.registerField('checkboxes', {
        ...
        edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
        addButton: "<span class=\"symbol\"><span class=\"fa fa-snowflake-o\"></span></span> Multi Choice",
        defaultAttributes: function (attrs) {
            attrs.field_options.options = [
                {
                    label: "First Option",
...
(function () {
    Formbuilder.registerField('checkWithText', {
        order: 5,
        view: "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div>\n    <label class='fb-option'>\n      <input type='checkbox' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n <input type ='text' size = '12px'/> </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='checkbox' />\n      Other\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
        edit: "<%= Formbuilder.templates['edit/options']() %>",
        addButton: "<span class=\"symbol\"><span class=\"fa fa-bullseye\"></span></span> check with text",
        defaultAttributes: function (attrs) {
            attrs.field_options.options = [
                {
                    label: "First Option",
...
(function () {
    Formbuilder.registerField('single-matrix', {
        order: 6,
        view: "<table> <tr>  <th></th> <% for (i in (rf.get(Formbuilder.options.mappings.MATRIXHEADEROPTION) || [])) { %>\n <th>\n  <%= rf.get(Formbuilder.options.mappings.MATRIXHEADEROPTION)[i].label %>\n  </th>\n <% } \ %> </tr> </thead> <% for (i in (rf.get(Formbuilder.options.mappings.MATRIXROWOPTION) || [])) { %>\n <tr>\n <th>  <%= rf.get(Formbuilder.options.mappings.MATRIXROWOPTION)[i].label %>\n  </th>\n <% for (i in (rf.get(Formbuilder.options.mappings.MATRIXHEADEROPTION) || [])) {%>\n <th style ='text-align : center'><input type='radio'/> </th>\n \n<% } \ %></tr> \n<% } \ %></tr></table>",
        edit: "<%= Formbuilder.templates['edit/matrix']() %>",
        addButton: "<span class=\"symbol\"><span class=\"fa fa-arrows-alt\"></span></span> Single Matrix",
        defaultAttributes: function (attrs) {
            attrs.field_options.matrixHeaderOptions = [
                {
                    label: "First Header"
            ...
            attrs.field_options.matrixRowOptions = [
                {
                    label: "First Row"
...
(function () {
    Formbuilder.registerField('mulitiSelect-matrix', {
        order: 7,
        view: "<table> <tr>  <th></th> <% for (i in (rf.get(Formbuilder.options.mappings.MATRIXHEADEROPTION) || [])) { %>\n <th>\n  <%= rf.get(Formbuilder.options.mappings.MATRIXHEADEROPTION)[i].label %>\n  </th>\n <% } \ %> </tr> </thead> <% for (i in (rf.get(Formbuilder.options.mappings.MATRIXROWOPTION) || [])) { %>\n <tr>\n <th>  <%= rf.get(Formbuilder.options.mappings.MATRIXROWOPTION)[i].label %>\n  </th>\n <% for (i in (rf.get(Formbuilder.options.mappings.MATRIXHEADEROPTION) || [])) {%>\n <th style ='text-align : center'><input type='radio'/> </th>\n \n<% } \ %></tr> \n<% } \ %></tr></table>",
        edit: "<%= Formbuilder.templates['edit/matrix']() %>",
        addButton: "<span class=\"symbol\"><span class=\"fa fa-delicious\"></span></span> Multi Select Matrix",
        defaultAttributes: function (attrs) {
            attrs.field_options.matrixHeaderOptions = [
                {
                    label: "First Header"
...
(function() {
  Formbuilder.registerField('ranking-text', {
    order: 8,
    view: "<div class='input-line'>\n <div><input type='radio'>Poor</input></div> <div><input type='radio'>Fair</input></div> <div><input type='radio'>Good</input></div> <div><input type='radio'>Very good</input></div> <div><input type='radio'>Excellent</input></div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-cog\"></span></span> Ranking-Text"
  });

}).call(this);

(function () {
    Formbuilder.registerField('ranking-number', {
        order: 9,
        view: "<div class='input-line'>\n <div><input type='radio'>01</input></div> <div><input type='radio'>02</input></div> <div><input type='radio'>03</input></div> <div><input type='radio'>04</input></div> <div><input type='radio'>05</input></div>",
        edit: "",
        addButton: "<span class=\"symbol\"><span class=\"fa fa-heartbeat\"></span></span> Ranking-Number"
    });
...
(function () {
    Formbuilder.registerField('fileupload', {
        order: 10,
        view: "<div class='input-line'><input type= 'file' name='picture' />\n</div>",
        edit: "",
        addButton: "<span class=\"symbol\"><span class=\"fa fa-picture-o\"></span></span> File Upload"
    });
...
this["Formbuilder"]["templates"]["edit/base_header"] = function (obj) {
    ...
    with (obj) {
        __p += '<div class=\'fb-field-label\'>\n  <span data-rv-text="model.' +
            ...
            '" class="hidden"></span>\n <span class=\'fa fa-arrow-right pull-right\'></span>\n <span data-rv-text="model.' +
            ((__t = (Formbuilder.options.mappings.FIELDID)) == null ? '' : __t) +
            '" class="hidden"></span>\n</div>';
...
this["Formbuilder"]["templates"]["edit/checkboxes"] = function (obj) {
    ...
    with (obj) {
        __p += '<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
            ...
            '\' />\n  Required\n</label> </br> <label> \n <input type=\'checkbox\' data-rv-checked=\'model.' +
            ((__t = (Formbuilder.options.mappings.ISIMAGEUPLOAD)) == null ? '' : __t) +
            '\' />\n  Image Required \n</label>  </br> <label> \n  <input type=\'checkbox\' data-rv-checked=\'model.' +
            ((__t = (Formbuilder.options.mappings.ISVOICEUPLOAD)) == null ? '' : __t) +
            '\' />\n  Voice Required \n</label>\n <!-- label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
...
this["Formbuilder"]["templates"]["edit/common"] = function (obj) {
    ...
    with (obj) {
        __p += '<div class=\'fb-edit-section-header\'>Label</div>\n\n<div class=\'fb-common-wrapper\'>\n  <div class=\'fb-label-description\'>\n    ' +
            ...
            '<div class=\'fb-edit-section-header\'>Video Url</div>\n <div class=\'fb-common-wrapper\'>\n  <div class=\'fb-label-description\'>\n' +
            ((__t = (Formbuilder.templates['edit/videoUrl']())) == null ? '' : __t) + '</div></div>';
...
this["Formbuilder"]["templates"]["edit/videoUrl"] = function (obj) {
    obj || (obj = {});
    var __t, __p = '', __e = _.escape;
    with (obj) {
        __p += '<input type=\'text\' placeholder = \'Add your video url here\' data-rv-input=\'model.' +
            ((__t = (Formbuilder.options.mappings.VIDEOURL)) == null ? '' : __t) +
            '\' />\n';
...
this["Formbuilder"]["templates"]["edit/isImageUpload"] = function (obj) {
    obj || (obj = {});
    var __t, __p = '', __e = _.escape;
    with (obj) {
        __p += '<div class=\'fb-edit-section-header\'>Image upload</div>\n<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
            ((__t = (Formbuilder.options.mappings.ISIMAGEUPLOAD)) == null ? '' : __t) +
...
this["Formbuilder"]["templates"]["edit/isVoiceUpload"] = function (obj) {
    obj || (obj = {});
    var __t, __p = '', __e = _.escape;
    with (obj) {
        __p += '<div class=\'fb-edit-section-header\'>Voice upload</div>\n<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
            ((__t = (Formbuilder.options.mappings.ISVOICEUPLOAD)) == null ? '' : __t) +
            '\' />\n  Voice should be uploaded\n</label>\n';
...
this["Formbuilder"]["templates"]["edit/options"] = function (obj) {
    ...
    with (obj) {
        ...
        __p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
            ...
            '\'>\n <input type="text" class= "hidden" data-rv-input = "option:id"/> <input type="checkbox" class=\'js-default-updated\' data-rv-checked="option:checked" />\n  <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-option ' +
...
this["Formbuilder"]["templates"]["edit/matrix"] = function (obj) {
    ...
    function print() { __p += __j.call(arguments, '') }
    with (obj) {
        __p += '<div class=\'fb-edit-section-header\'>Header Options</div>\n\n';
       
        __p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
            ((__t = (Formbuilder.options.mappings.MATRIXHEADEROPTION)) == null ? '' : __t) +
            '\'>\n <input type="text" class= "hidden" data-rv-input = "option:id"/> <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-option js-add-matrix-header ' +
            ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
            '" title="Add Header Option"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-remove-option js-remove-matrix-header ' +
            ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
            '" title="Remove Header Option"><i class=\'fa fa-minus-circle\'></i></a>\n</div>\n\n';
        
        __p += '\n\n<div class=\'fb-bottom-add\'>\n  <a class="js-add-matrix-header ' +
            ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
            '">Add Header</a>\n</div>\n';

        //Matrix row options  editor 

        __p += '<div class=\'fb-edit-section-header\'>Row Options</div>\n\n';

        __p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
            ((__t = (Formbuilder.options.mappings.MATRIXROWOPTION)) == null ? '' : __t) +
            '\'>\n <input type="text" class= "hidden" data-rv-input = "option:id"/> <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-matrix-row ' +
            ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
            '" title="Add Header Option"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-remove-matrix-row ' +
            ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
            '" title="Remove Header Option"><i class=\'fa fa-minus-circle\'></i></a>\n</div>\n\n';
